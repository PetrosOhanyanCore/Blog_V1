...
{
    public abstract class Blog_Test_Petros_OhanyanWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Blog_Test_Petros_OhanyanWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Blog_Test_Petros_OhanyanWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Blog_Test_Petros_OhanyanDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Blog_Test_Petros_OhanyanDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Blog_Test_Petros_OhanyanDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Blog_Test_Petros_OhanyanDbContext, Task<T>> func)
        {
            T result;
