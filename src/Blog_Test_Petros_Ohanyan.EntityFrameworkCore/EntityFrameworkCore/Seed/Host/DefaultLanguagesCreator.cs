...
namespace Blog_Test_Petros_Ohanyan.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = Blog_Test_Petros_OhanyanConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Blog_Test_Petros_OhanyanDbContext context)
        {
            _context = context;
        }
